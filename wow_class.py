...
QUESTIONS = [
    ...
    {
        "q": "Q3. 갑작스러운 위기나 예상치 못한 공격을 받았을 때, 당신의 행동은?",
    ...
    {
        "q": "Q4. RPG 게임이나 스포츠에서 당신이 가장 쾌감을 느끼는 순간은?",
    ...
    {
        "q": "Q5. 일상에서 극심한 스트레스나 압박을 받을 때, 당신의 대처법은?",
    ...
    {
        "q": "Q6. 까다로운 문제나 적을 상대할 때, 당신의 주된 전략은?",
    ...
    {
        "q": "Q11. 당신의 개인 공간(책상, 방)을 대하는 태도나 상태는?",
    ...
    {
        "q": "Q12. 사회의 규칙이나 룰에 대한 당신의 기본적인 태도는?",
    ...
    {
        "q": "Q13. 강력한 보스 몬스터와 마주쳤을 때, 파티 내 당신의 역할은?",
    ...
    {
        "q": "Q16. 오롯이 혼자 보낼 수 있는 자유 시간, 무엇을 선호하나요?",
    ...
    {
        "q": "Q18. 당신에게 단 하나의 마법 능력이 주어진다면 어떤 것을 고르겠습니까?",
    ...
    {
        "q": "Q19. 파티가 전멸할 위기에 처한 최후의 결전, 당신의 결단은?",
    ...
    {
        "q": "Q20. 모든 전투가 끝난 후, 사람들의 기억에 남고 싶은 당신의 모습은?",
    ...
    {
        "q": "Q21. 전투나 업무를 수행할 때 당신이 가장 카타르시스를 느끼는 템포는?",
    ...
    {
        "q": "Q22. 동료들과 협력하는 과정에서 당신이 가장 빛나는 순간은?",
    ...
    {
        "q": "Q23. 당신의 가슴을 가장 뛰게(아드레날린이 솟게) 만드는 상황은?",
    ...
    {
        "q": "Q24. 긴급한 위기 상황에서 당신을 지배하는 감각은?",
