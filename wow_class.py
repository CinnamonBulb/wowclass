...
QUESTIONS = [
    ...
    },
    {
        ...
        "opts": [
            {"t": "조급해하지 않고 흔들림 없이 자신의 자리를 묵묵히 지켜낸 전문인력.", "w": {"Dist":10, "Res":6, "Pac":4}}, 
            {"t": "부패한 자들을 쳐내어 조직을 완벽하게 정화해버린 단호한 인사팀.", "w": {"Ord":10, "Agg":6, "Mob":4}}, 
            {"t": "복잡한 변수들을 치밀하게 계산하여 팀원 전체의 기량을 최고치로 끌어올린 부서장.", "w": {"Log":10, "Sup":6, "Cpx":4}}, 
            {"t": "기존의 낡은 관행을 갈아엎어 손실도 보았으나, 그 이상의 개혁을 이뤄낸 혁신팀장.", "w": {"Shd":10, "Nat":6, "Des":4}}
        ]
    },
    {
