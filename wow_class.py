...
QUESTIONS = [
    ...
    },
    {
        ...
        "opts": [
            {"t": "우직하게 감정을 통제하며 오랜 시간 흔들림 없이 버틴다.",               "w": {"Res":10, "Ord":6, "Pac":4}}, 
            {"t": "상황이 지나간 뒤 복수를 위한 치명적인 반격을 세팅한다.",                     "w": {"Agg":10, "Dist":6, "Mob":4}}, 
            {"t": "내 뼈를 깎아서 험악해진 분위기를 보듬고 주변 사람들을 안심시킨다.",               "w": {"Sup":10, "Shd":6, "Des":-4}}, 
            {"t": "정교하게 논리를 가공 및 정리하여 상대를 압도하는 방법을 구상한다.",                   "w": {"Nat":10, "Log":6, "Cpx":4}}
        ]
    },
    {
        ...
        "opts": [
            ...
            {"t": "오랜 시간 공들여 외부의 어떤 위기나 공격에도 흔들리지 않도록 조직의 견고한 질서를 확립하는 관리자", "w": {"Ord":10, "Res":6, "Pac":4}}, 
