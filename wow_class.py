...
SPECS = {
    ...
    "악마 흑마법사":      {"Res":15,"Sup":15,"Dist":80, "Log":60,"Agg":65,"Nat":10,"Ord":30,"Shd":85, "Mob":25, "Cpx":75, "Des":60, "Pac":50},
...
QUESTIONS = [
    ...
    },
    {
        ...
        "opts": [
            ...
            {"t": "외부의 어떤 위기나 공격에도 흔들리지 않도록 조직의 견고한 질서를 확립해나가는 관리자", "w": {"Ord":10, "Res":6, "Pac":4}}, 
